...
var EmailControl_1 = require("../EmailControl");
...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.getUserAvatar = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var user, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, sharp_1.default(req.file.buffer).resize({ width: 500, height: 500 }).png().toBuffer()];
                    case 2:
                        buffer = _a.sent();
                        user.avatar = buffer;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        EmailControl_1.EmailControl.sendCancellationEmail(user.email, user.name);
                        res.status(200).send(user);
                        return [3 /*break*/, 4];
                    case 3:
                        err_5 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        user = _a.sent();
                        user === null || user === void 0 ? void 0 : user.remove();
                        if (!user) {
                            res.status(404).send();
                        }
                        res.send(user);
    ...
    __decorate([
        ...
        decorators_1.use(auth_1.checkForAuth)
    ], UserController.prototype, "getAccountBirthday", null);
    __decorate([
